...
const projectData = [
    {
      title: "Weather App",
      subTitle:
        "A fullstack application that provides real-time weather information for various locations around the world.",
      thumbnail: "../img/thumbnails/weather-app-thumbnail.png",
      description:
        "The Weather App provides real-time weather updates and forecasts for cities worldwide, featuring a responsive design for optimal viewing on any device. Its user-friendly interface ensures an intuitive navigation experience, making it easy to access current conditions and future forecasts effortlessly.",
      techStack: ["React.js", "Express.js", "Node.js", "MongoDB"],
      srcURL: "https://weather-app-shubham31.netlify.app/",
    },
    {
        title: "Expense Tracker",
        subTitle:
          "A Frontend application for expense management, featuring add, edit, delete, and total expense options.",
        thumbnail: "../img/thumbnails/expense-tracker-thumbnail.png",
        description:
          "Manage your expenses effectively with our web application! Add, edit, and delete expenses, filter them by category, and view total expenditures effortlessly. Enjoy a responsive design that works seamlessly on both desktop and mobile devices, ensuring easy access to your financial data anytime.",
        techStack: ["React.js", "HTML", "CSS", "JavaScript"],
        srcURL: "https://expense-tracker-shubham31.netlify.app/",
    },
    {
        title: "To Do List",
        subTitle:
          "A Fullstack application that allows a user to create a new tasks to do and remove existing tasks.",
        thumbnail: "../img/thumbnails/todolist-thumbnail.png",
        description:
          "This dynamic web application helps you manage your daily life tasks. Users can create and delete tasks, which are stored persistently in a MongoDB database, ensuring data persists across sessions for seamless task management.",
        techStack: ["HTML", "CSS", "JavaScript", "Node.js", "MongoDB"],
        srcURL: "https://to-do-list-shubham31.onrender.com",
    },
    {
      title: "Tic Tac Toe",
      subTitle:
        "A Frontend application for playing the classic Tic Tac Toe with your friends.",
      thumbnail: "../img/thumbnails/tic-tac-toe-thumbnail.png",
      description:
        "Enjoy a customizable Tic Tac Toe game with options for player names and board sizes, including a solo mode against a computer opponent. The game features a responsive design for seamless play on desktop and mobile devices, ensuring a smooth and enjoyable experience for all players.",
      techStack: ["HTML", "CSS", "JavaScript"],
      srcURL: "https://tic-tac-toe-shubham31.netlify.app/",
    },
    {
        title: "Music Library",
        subTitle:
          "A Frontend application for organizing music collections and listening to your favourite songs.",
        thumbnail: "../img/thumbnails/music-library-thumbnail.png",
        description:
          "Music Library is a frontend application for organizing music collections. It allows users to add and edit songs effortlessly, search by title, artist, or genre for quick access, and provides a responsive design ensuring usability across desktop and mobile devices. This template website operates without backend support, focusing solely on frontend functionality.",
        techStack: ["HTML", "CSS"],
        srcURL: "https://music-library-shubham31.netlify.app/",
    },
    // {
    //     title: "Project Title",
    //     subTitle:
    ...
    elem.innerHTML = buildTemplate(
      `<div class='projects-header'>
       ...
       <div class="card-buttons">
          <a href="https://github.com/Shubham-Jaiswal-31" target="_blank" class="card-btn" style="float: right; height: 2.35rem; color: #fff; background-color: #68d372; padding: .375rem .75rem; border-radius: .25rem;"><i class="fa-regular fa-file-code"></i>Source Code</a>
...
async function getRepoList() {
  try {
    const response = await fetch(
      "https://api.github.com/users/Shubham-Jaiswal-31/repos"
    );
